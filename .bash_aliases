...
alias mytime='date +'%A, %B %m %Y at%l:%M%P %Z''


# Listing
alias ll='ls -lah --color=auto'                   # Long List
alias ls='eza -lah --icons'
alias lh='ls -d .* --color=auto | column -s=\n'   # List Hidden files
alias llh='ls -lhd .* --color=auto'               # Long List Hiddent
alias os='lsb_release -a'                         # Get OS Version


# Find
alias fd='fdfind --threads=4 --color=always'
