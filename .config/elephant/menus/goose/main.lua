    ...
    return {
        {
            ...
            Subtext = "Start a fresh goose session",
            Actions = { default = "lua:ActionNew" },
        },
        ...
        {
            Text = "Goose: Switch Model",
            Subtext = "Select from Gemini or local Ollama models",
            SubMenu = "goose_models",
        },
        {
            Text = "Goose: Configure",
            Subtext = "Full interactive configuration",
            Actions = { default = "lua:ActionConfig" },
        },
    }
end

function ActionNew()
    RunInTerminal(GOOSE_CMDS.SESSION_NEW)
end
function ActionConfig()
    RunInTerminal(GOOSE_CMDS.CONFIGURE)
end
